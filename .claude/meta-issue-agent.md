...
- Create OR update the single questions document following @instructions/issue-creation-instructions.md naming patterns
...
- Reference @.claude/commands/start/issue-workflow.md for detailed orchestration patterns
...
- @.claude/commands/start/issue-workflow.md - (Relevance: Complete workflow specification and methodology)
...
- @.claude/commands/start/refinement-workflow.md - (Relevance: Systematic thinking methodology)
...
- @instructions/example-instructions-best-practices.md - (Relevance: Documentation standards)
- @instructions/issue-creation-instructions.md - (Relevance: Issue organization and naming conventions)
