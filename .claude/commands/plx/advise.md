...
---
role: @agents/meta/ultra-meta-agent.md or @agents/meta/meta-issue-agent.md
...
- Reference @workflows/issue-workflow.md for detailed orchestration patterns
...
- @workflows/issue-workflow.md - (Relevance: Complete workflow specification and methodology)
