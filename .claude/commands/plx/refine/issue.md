...
Your task is to help refine a specific issue as part of Phase 3 of the @workflows/issue-workflow.md. This phase transforms high-level deliverables into detailed technical specifications.

<workflow-context>
The refinement phase is part of a 6-phase feature development workflow:
- Phase 1: Discovery & Context Gathering → @templates/workflows/discovery-template.md
- Phase 2: Requirements Elaboration → @templates/workflows/requirements-template.md
- **Phase 3: Refinement & Architecture** → @templates/workflows/refinement-template.md (Current Phase)
...
3. **Execute Refinement**:
   ...
   - Use @templates/workflows/refinement-template.md for output
