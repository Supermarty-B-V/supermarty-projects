...
2. **Create Feedback Document**: Use the @templates/review/feedback-template.md to create a comprehensive feedback document in the `feedback/` directory with the filename pattern: `feedback-[component-type]-[component-name]-[YYYYMMDD].md`
...
<output_format>
1. Create a feedback document using @templates/review/feedback-template.md in `feedback/` directory
