...
3. **DEVELOP - Research and Apply Expertise:** Based on artifact type, examine:
   ...
   - For Workflows: @templates/meta/workflow-template.md, @workflows/refinement-workflow.md, @workflows/issue-workflow.md existing `workflows/`
...
- @workflows/refinement-workflow.md - (Relevance: Example of sophisticated workflow design)
