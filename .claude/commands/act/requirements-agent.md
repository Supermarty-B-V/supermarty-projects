...
6. **Create Requirements Document**: Generate output using @templates/workflows/requirements-template.md:
...
- Follow flow documentation standards from @blocks/refinements/activity-flows-block.md
...
- WHEN creating output ALWAYS use @templates/workflows/requirements-template.md
...
- @templates/workflows/requirements-template.md - (Relevance: Output template for requirements phase)
- @blocks/refinements/activity-flows-block.md - (Relevance: Structure for documenting flows)
- @blocks/refinements/deliverables-block.md - (Relevance: Format for listing deliverables)
- @templates/workflows/discovery-template.md - (Relevance: Input from discovery phase)
- @blocks/refinements/user-story-block.md - (Relevance: Understanding story point sizing)
...
Create a complete requirements document following the @templates/workflows/requirements-template.md structure. The output should be a single markdown file that:
