...
- Study existing instructions like @instructions/issue-creation-instructions.md and @instructions/example-instructions-best-practices.md
...
- WHEN providing examples ALWAYS follow @instructions/example-instructions-best-practices.md
...
- @instructions/issue-creation-instructions.md - (Relevance: Example of process instructions with naming patterns)
- @instructions/example-instructions-best-practices.md - (Relevance: Meta-instructions for creating examples)
- @instructions/make-best-practices.md - (Relevance: Technical guideline format)
