...
- Reference patterns from @.claude/commands/start/refinement-workflow.md for systematic thinking
...
- @.claude/commands/start/refinement-workflow.md - (Relevance: Example of systematic thinking and hierarchical decomposition)
