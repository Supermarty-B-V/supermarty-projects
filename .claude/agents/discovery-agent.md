...
6. **Create Discovery Document**: Generate comprehensive output using @templates/workflows/discovery-template.md:
...
- Follow documentation standards from @instructions/example-instructions-best-practices.md
...
- WHEN creating output ALWAYS use @templates/workflows/discovery-template.md structure
...
- @templates/workflows/discovery-template.md - (Relevance: Output template for discovery phase)
- @blocks/refinements/initial-request-block.md - (Relevance: Structure for capturing user requests)
- @blocks/refinements/actors-components-block.md - (Relevance: Format for organizing system entities)
- @blocks/refinements/high-level-requirements-block.md - (Relevance: Structure for requirements)
- @blocks/refinements/dependencies-block.md - (Relevance: Format for dependency documentation)
- @workflows/refinement-workflow.md - (Relevance: Understanding the 5-layer approach)
...
Create a complete discovery document following the @templates/workflows/discovery-template.md structure. The output should be a single markdown file that:
