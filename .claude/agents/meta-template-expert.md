...
- Include detailed placeholder instructions using @instructions/example-instructions-best-practices.md conventions
...
- Ensure consistency with project's documentation standards and @templates/meta/agent-template.md structure
...
- @instructions/example-instructions-best-practices.md - (Relevance: Placeholder and instruction formatting standards)
- @templates/meta/agent-template.md - (Relevance: Standard structure for all agent documentation)
