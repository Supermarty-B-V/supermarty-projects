...
- Follow the workflow defined in @.claude/commands/start/bug-workflow.md.
...
- @.claude/commands/start/bug-workflow.md - (Relevance: The complete workflow specification.)
