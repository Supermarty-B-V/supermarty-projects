...
2. **Apply 5-Layer Refinement**: Following @.claude/commands/start/refinement-workflow.md:
...
- Follow the systematic 5-layer approach from @.claude/commands/start/refinement-workflow.md
...
- @.claude/commands/start/refinement-workflow.md - (Relevance: The 5-layer refinement approach)
